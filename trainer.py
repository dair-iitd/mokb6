...
class Trainer:
    ...
    def __init__(self, args, ngpus_per_node):
        ...
        # save the log
        fh = logging.FileHandler('{}/log.txt'.format(self.args.model_dir))
        ...
        # continue training if ckpt given
        if args.continue_training:
            ckt_dict = torch.load(args.continue_training, map_location=lambda storage, loc: storage)
    ...
    def train_loop(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            if is_best:
                ...
                if best_epoch and self.patience and (epoch - best_epoch + 1 >= self.patience):
                    logger.info('Lost patience at {} epoch. Best epoch at {}'.format(epoch, best_epoch))
                    break
